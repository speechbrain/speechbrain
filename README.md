...
1.3 [Test installation](#test-installation)
1.4 [Folder Structure](#folder-structure)
1.5 [How to run an experiment](#how-to-run-an-experiment)
1.6 [Configuration files](#configuration-files)
1.7 [Data reading and writing](#data-reading-and-writing)
1.8 [Execute computation class](#execute-computation-class)
1.9 [Tensor format](#tensor-format)
1.10 [Data preparation](#data-preparation)

2. [Feature extraction](#feature-extraction)
2.1. [Short-time Fourier transform (STFT)](#short-time-fourier-transform-(stft))
2.2. [Spectrograms](#spectrograms)
2.3. [Filter banks (FBANKs)](#filter-banks-(fbanks))
2.4. [Mel Frequency Cepstral Coefficients (MFCCs)](#mel-frequency-cepstral-coefficients-mfccs)

3. [Data augmentation](#data-augmentation)
3.1. [Noise](#noise)
3.2. [Reverberation](#reverberation)
3.3. [Speed perturbation](#speed-perturbation)
3.4. [Other distortions](#other-distortions)

4. [Neural Networks](#neural-networks)
4.1. [Training](#training)
4.2. [Validation](#validation)
4.3. [Test](#test)
4.4. [Saving checkpoints](#saving-checkpoints)
4.5. [Architectures](#architectures)
4.6. [Normalization](#normalization)
4.7. [Losses](#losses)
4.8. [Optimizers](#optimizers)
4.9. [Learning rate scheduler](#learning-rate-scheduler)
4.10. [Replicate computations](#replicate-computations)
4.11. [Residual, Skip, and Dense connections](#replicate-computations)
4.12. [Classification example](#losses)
4.13. [Sequence-to-sequence example](#losses)
4.13. [Regression example](#losses)

5. [HMM-DNN speech recogntition](#hmm-dnn-speech-recogntition)
6. [End-to-end speech recogntition](#end-to-end-speech-recogntition)
7. [Speech enhancement](#speech-enhancement)
8. [Speaker recognition and diarization](#speaker-recognition-and-diarization)
9. [Multi-microphone processing](#multi-microphone-processing)
