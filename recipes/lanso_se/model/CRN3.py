...
class Encoder(torch.nn.Module):
    def __init__(self, in_channels=1, channels=8, layers=5, scale=2) -> None:
        super().__init__()
...
class Decoder(torch.nn.Module):
    def __init__(self, in_channels=512, layers=5, scale=2) -> None:
        ...
        self.decnn_b5 = DeCNN_Block(256, 64)
        self.decnn_b4 = DeCNN_Block(128, 32)
        self.decnn_b3 = DeCNN_Block(64, 16)
        self.decnn_b2 = DeCNN_Block(32, 8, output_padding=(0,1))
        self.decnn_b1 = DeCNN_Block(16, 1)
