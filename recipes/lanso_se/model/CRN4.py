...
class Encoder(torch.nn.Module):
    def __init__(self, in_channels=1, channels=4, layers=5, scale=2) -> None:
        super().__init__()
...
class Decoder(torch.nn.Module):
    def __init__(self, in_channels=128, layers=5, scale=2) -> None:
        super().__init__()

        self.decnn_b5 = DeCNN_Block(int(in_channels), int(in_channels/4))
        self.decnn_b4 = DeCNN_Block(int(in_channels/2), int(in_channels/8))
        self.decnn_b3 = DeCNN_Block(int(in_channels/4), int(in_channels/16))
        self.decnn_b2 = DeCNN_Block(int(in_channels/8), int(in_channels/32), output_padding=(0,1))
        self.decnn_b1 = DeCNN_Block(int(in_channels/16), 1)
