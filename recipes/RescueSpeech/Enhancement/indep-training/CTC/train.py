...
class ASR(sb.core.Brain):
    ...
    def compute_forward_enhance(self, batch, stage):
        ...
        # snt_id = batch.id
        # self.save_audio(snt_id[0], batch.noisy_sig, clean.squeeze(-1), est_source)

        # return batch.noisy_sig[0]   # Noisy WER- 67.58
        # return clean.squeeze(-1)    # Clean WER- 23.11
        return [est_source, sep_h], clean.squeeze(-1)  # Enhanced WER- 61.03
