...
class ASR(sb.core.Brain):
    ...
    def compute_objectives(self, predictions, targets, stage="train"):
        ...
        ids, words, word_lens = targets[0]
        _, phns, phn_lens = targets[1]
        _, ends, end_lens = targets[2]
        ...
        phns_true = undo_padding(phns, phn_lens)
        ...
        if self.training_type == "forward":
            ...
            prev_alignments = params.aligner.get_prev_alignments(
                ids, pout, pout_lens, poss_phns, poss_phn_lens
            )
    ...
    def fit_batch(self, batch):
        ...
        """
        inputs, words, phns, ends = batch
        targets = words, phns, ends
...
prepare_timit(
    ...
    phn_set=str(params.phn_set),
)
train_set = params.train_loader()
valid_set = params.valid_loader()
first_x, first_wrds, first_phns, first_ends = next(iter(train_set))
