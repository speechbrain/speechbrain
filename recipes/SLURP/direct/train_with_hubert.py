...
We encode input waveforms into features using the HuBert model,
...
Run using:
> python train_with_hubert.py hparams/train_with_hubert.yaml
...
class SLU(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        hubert_out = self.modules.hubert(wavs)
        # SLU forward pass

        encoder_out = self.hparams.slu_enc(hubert_out)
