...
class CNN14PSI_encoderdecoder_channeldim(nn.Module):
    """
    This class estimates a saliency map on the STFT domain, given classifier representations.
    ...
    def __init__(self, dim=128, outdim=1, apply_sigmoid=False):
        ...
        self.convt1 = nn.ConvTranspose2d(dim, dim // 4, 7, (3, 1), 1)
        self.convt2 = nn.ConvTranspose2d(dim // 2, dim // 4, 7, (3, 1), 1)
        self.convt3 = nn.ConvTranspose2d(
            dim // 4, dim // 4, (12, 2), (3, 1), (1, 0)
        )
        self.convt4 = nn.ConvTranspose2d(
            dim // 4, dim // 4, (7, 1), (5, 2), (1, 1)
        )
        self.convt5 = nn.ConvTranspose2d(dim // 4, dim // 8, 7, (2, 1), 1)
        self.convt6 = nn.ConvTranspose2d(
            dim // 8, dim // 8, (7, 4), (5, 1), (2, 1)
        )
        self.convt7 = nn.ConvTranspose2d(
            dim // 8, dim // 8, (4, 1), (2, 1), (0, 0)
        )
        self.convt8 = nn.ConvTranspose2d(
            dim // 8, dim // 16, (10, 1), (3, 1), (4, 0)
        )
        self.convt9 = nn.ConvTranspose2d(dim // 16, outdim, (8, 1), (7, 1), 0)
        self.convf = nn.Conv2d(outdim, outdim, (1, 11), (1, 1), 0)
