...
export ORION_DB_ADDRESS=/home/dborra/projects/def-ravanelm/dborra/tpe_csbj_EEGNet_EPFLP300_stage2.pkl # This is the database where orion will save the results
...
orion hunt -n $HPOPT_EXPERIMENT_NAME -c $HPOPT_CONFIG_FILE --exp-max-trials=50  \
        ...
        --cnn_septemporal_kernelsize_ 24 \
