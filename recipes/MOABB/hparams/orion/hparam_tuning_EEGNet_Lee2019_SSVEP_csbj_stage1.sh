...
export ORION_DB_ADDRESS=/home/dborra/projects/def-ravanelm/dborra/tpe_csbj_EEGNet_Lee2019_SSVEP_stage1.pkl # This is the database where orion will save the results
