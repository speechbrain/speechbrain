...
for i in {1..5}
do
	python train.py hparams/train.yaml --seed=$i --data_folder=/localscratch/timers-and-such/ --number_of_epochs=2 --train_splits=["train-synth"] --experiment=train-synth-only
done
