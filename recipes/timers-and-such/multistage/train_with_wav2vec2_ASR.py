...
class SLU(sb.Brain):
    def compute_forward(self, batch, stage):
        ...
        asr_tokens = self.hparams.asr_model(wavs)

        # run if you need transcriptions
        # transcription = self.hparams.wav2vec_processor.batch_decode(asr_tokens)

        # print('wav2vec :',transcription[1])
