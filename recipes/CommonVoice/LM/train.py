...
def csv2text():
    ...
    annotation_file = open(hparams["train_csv"], "r", newline="", encoding="utf-8")
...
if __name__ == "__main__":
    ...
    os.system(cmd)
    with (
        open(tmp_ngram_file, "r", encoding="utf-8") as read_file,
        open(hparams["ngram_file"], "w", encoding="utf-8") as write_file,
    ):
        has_added_eos = False
