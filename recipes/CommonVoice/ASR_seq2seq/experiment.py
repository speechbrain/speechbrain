...
# We retrieve only the first mini_batches because the initialisation
# isn't done on multiple GPUs and it could lead to Out Of Memory !
first_x = [elem[0:1] for elem in first_x]
first_y = [elem[0:1] for elem in first_y]
