...
def dataio_prepare(hparams):
    ...
    train_transcripts = glob.glob(
        os.path.join(data_folder, hparams["train_transcripts_pattern"]), recursive=True
    )
    dev_transcripts = glob.glob(
        os.path.join(data_folder, hparams["dev_transcripts_pattern"]), recursive=True
    )
    test_transcripts = glob.glob(
        os.path.join(data_folder, hparams["test_transcripts_pattern"]), recursive=True
    )
