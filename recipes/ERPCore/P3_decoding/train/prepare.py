...
def load_and_preprocess_p3_erp_core(hparams):
    ...
    event_id = {'11.0': 1, '12.0': 2, '13.0': 3, '14.0': 4, '15.0': 5,
                '21.0': 6, '22.0': 7, '23.0': 8, '24.0': 9, '25.0': 10,
                '31.0': 11, '32.0': 12, '33.0': 13, '34.0': 14, '35.0': 15,
                '41.0': 16, '42.0': 17, '43.0': 18, '44.0': 19, '45.0': 20,
                '51.0': 21, '52.0': 22, '53.0': 23, '54.0': 24, '55.0': 25}
    data_fpath = glob.glob(os.path.join(hparams["data_folder"],
                                        hparams["sbj_id"],
                                        "eeg",
                                        "*.set"))[0]
    # loading EEGLab dataset
    raw_eeglab = mne.io.read_raw_eeglab(data_fpath, verbose="INFO", preload=True)
    ...
    evoked = mne.Epochs(raw, events=events_from_annot, event_id=event_id,
                        tmin=tmin, tmax=tmax, baseline=(baseline_tmin, baseline_tmax),
                        preload=True)
    ...
    deviant_ids = [evoked.event_id[key] for key in ["11.0", "22.0", "33.0", "44.0", "55.0"]]
