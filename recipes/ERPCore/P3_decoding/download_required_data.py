...
parser.add_argument("--data_folder", type=str, required=True, help='Target data directory')
args = parser.parse_args()

os.makedirs(args.data_folder, exist_ok=True)
print("Downloading ERPCore P3 dataset...")
download_file(ERPCORE_P3_URL, os.path.join(args.data_folder, "ERPCore_P3.zip"), unpack=True)
