...
# tell flake to ingore this file
# flake8: noqa
    ...
    return {
        ...
        "mac": makeDic(
            ...
            (
                ...
                "AX",
                False,
            ),  # TODO: is this really the best approximation?
            ("AY", eye),
            ("b", b),
            ("C", ch),
            ("d", d),
            ...
            lex_footer=lambda f: (
                f.write(" -e tS\n"),
                f.close(),
                os.chmod("substitute.sh", 493),
            ),  # 493 = 0755, but no way to specify octal that works on both Python 2.5 and Python 3 (0o works on 2.6+)
        ...
        "cmu": makeDic(
            ...
            (
                ...
                "AH",
                False,
            ),  # seems they don't use AX as festival-cmu does
            ("ER", e_as_in_herd),  # TODO: check this one
            ("AY", eye),
            ("B", b),
            ("CH", ch),
        ...
        "bbcmicro": makeDic(
            ...
            lex_entry_format=as_utf8("> %s_")
            + chr(128)
            + as_utf8(
                "%s"
            ),  # (specifying 'whole word' for now; remove the space before or the _ after if you want)
            lex_read_function=lambda lexfile: [
                ...
                for w in filter(
                    ...
                    [
                        w.split(chr(128))
                        for w in getBuf(lexfile).read().split(">")
                    ],
                )
        ...
        "amiga": makeDic(
            ...
            (
                ...
                "IYAH",
                False,
            ),  # or try IYER, or there might be a phoneme for it
        ...
        "unicode-ipa": makeDic(
            ...
            (
                ...
                u_as_in_but,
                False,
            ),  # 28c sometimes mistakenly written as 1d27
            ("\u0252", o_as_in_orange),
...
""",
        ...
        "pinyin-approx": makeDic(
            ...
            cleanup_regexps=[
                ...
                (
                    "0",
                    "5",
                ),  # comment out if the synth supports 'tone 0 for unvoiced'
        ...
        "kana-approx": makeDic(
            ...
            ("\u3065", d),  # du (and so on)
            ("\u3066\u3085", th_as_in_think),
            (th_as_in_them, "\u3066\u3085", False),
            ("\u3075", f),
            ("\u3050", g),
            ("\u306f", h),  # ha (as hu == fu)
            ("\u3058\u3085", j_as_in_jump),
            (ge_of_blige_etc, "\u3058\u3085", False),
            ("\u304f", k),
            ("\u308b", l),
            (r, "\u308b", False),
            ("\u3080", m),
        ...
        "deva-approx": makeDic(
            ...
            (
                ...
                d,
                False,
            ),  # TODO: check which sounds better for reading English words
            ("\u0920", th_as_in_them),  # (very approximate)
            ("\u0948", e_as_in_them),
            ("\u0910", e_as_in_them, False),
            ("\u0947", a_as_in_ate),
            ("\u090f", a_as_in_ate, False),
            ("\u092b\u093c", f),
            ("\u0917", g),
            ("\u0917\u093c", g, False),  # (Hindi; differs in others)
            ("\u0939", h),
            ("\u0903", h, False),
            ("\u093f", i_as_in_it),
            ("\u0907", i_as_in_it, False),
            ...
            ("\u0915", k),
            ("\u0916", k, False),
            ("\u0916\u093c", opt_scottish_loch),
            ("\u0915\u093c", opt_scottish_loch, False),  # ?
            ("\u0932", l),
            ("\u092e", m),
            ("\u0928", n),
            ("\u0923", n, False),
            ("\u0902", ng),
            ("\u092a", p),
            ("\u092b", f, False),  # (Hindi; p in some others?)
            ("\u0930", r),
            ("\u0921\u093c", r, False),
            ("\u0938", s),
            ("\u0936", sh),
            ...
            ("\u0925", t, False),
            ("\u0941", opt_u_as_in_pull),
            ("\u0909", opt_u_as_in_pull, False),
            ("\u0942", oo_as_in_food),
            ("\u090a", oo_as_in_food, False),
            ("\u094c", close_to_or),
            ("\u0914", close_to_or, False),
            ("\u094b", opt_ol_as_in_gold),
            ("\u0913", opt_ol_as_in_gold, False),
            ("\u0935", v),
            (w, "\u0935", False),
            ("\u092f", y),
            ("\u091c\u093c", z),
            ...
            cleanup_regexps=[
                ...
                (
                    "([\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939]\u093c?)(?![\u0905\u093e-\u0942\u0947\u0948\u094b\u094c])",
                    "\\1\u094d",
                ),
                (
                    "(?<=[\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u0905",
                    "",
                ),
                ("(.)\u094d\u02c8", "\u02c8\\1"),
                # replace vowel signs with vowel letters if not preceded by consonants:
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u093e",
                    "\u0906",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u093f",
                    "\u0907",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u0940",
                    "\u0908",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u0941",
                    "\u0909",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u0942",
                    "\u090a",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u0947",
                    "\u090f",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u0948",
                    "\u0910",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u094b",
                    "\u0913",
                ),
                (
                    "(?<![\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939\u093c])\u094c",
                    "\u0914",
                ),
            ],
            cvtOut_func=unicode_preprocess,
            cvtOut_regexps=[
                ...
                (
                    "([\u0902\u0903\u0915-\u0917\u091a-\u091d\u091f-\u0928\u092a-\u0930\u0932\u0935-\u0939]\u093c?)(?![\u0905\u094d\u093e-\u0942\u0947\u0948\u094b\u094c])",
                    "\\1\u0905",
                ),
                ("\u094d", ""),
...
E.g.: python lexconvert.py --try festival h @0 l ou1
 or: python lexconvert.py --try unicode-ipa '\\u02c8\\u0279\\u026adn\\u0329' (for Unicode put '\\uNNNN' or UTF-8)"""
    ...
    for phones in getInputText(
        i + 2, "phonemes in " + format + " format", "maybe"
    ):
        espeak = convert(phones, format, "espeak")
        w = os.popen("espeak -x", "w")
        getBuf(w).write(
            markup_inline_word("espeak", espeak) + as_utf8("\n")
...
Convert phonemes from <format> and try it with Mac OS British voices (see --mac-uk for details)"""
    ...
    ), "--trymac-uk has not been tested with Python 3, I don't want to risk messing up your system files, please use Python 2"
    format = sys.argv[i + 1]
    if not format in lexFormats:
        return (
            "No such format "
    ...
    for resp in getInputText(
        ...
        m = MacBritish_System_Lexicon(
            "", os.environ.get("MACUK_VOICE", "Daniel")
        )
        try:
            try:
...
Set format to 'all' if you want to see the phonemes in ALL supported formats."""
    ...
    for response in getInputText(i + 2, "text", "maybe"):
        response = pipeThroughEspeak(
            as_utf8(response)
            .replace("\u2032".encode("utf-8"), as_utf8(""))
            .replace("\u00b4".encode("utf-8"), as_utf8(""))
            .replace("\u02b9".encode("utf-8"), as_utf8(""))
            .replace("\u00b7".encode("utf-8"), as_utf8(""))
        )  # (remove any 2032 and b7 pronunciation marks before passing to eSpeak)
        if (
            not as_utf8("\n") in response.rstrip()
            and as_utf8("command") in response
        ):
            return response.strip()  # 'bad cmd' / 'cmd not found'
        if format == "all":
            formats = sorted(k for k in lexFormats.keys() if not k == "example")
        else:
            formats = [format]
        for format in formats:
            ...
            def out(doOneoff=True):
                ...
                if doOneoff:
                    getBuf(sys.stdout).write(
                        as_utf8(checkSetting(format, "inline_oneoff_header"))
                    )
                getBuf(sys.stdout).write(
                    as_utf8(checkSetting(format, "inline_header"))
                )
                output_clauses(
                    format,
                    convert(
                        parseIntoWordsAndClauses("espeak", response),
                        "espeak",
                        format,
                    ),
                )
                getBuf(sys.stdout).write(
                    as_utf8(checkSetting(format, "inline_footer"))
                )
                print("")
...
You can optionally set the RUBY_GRADINT_CGI environment variable to the URL of an instance of Gradint Web Edition to generate audio links for each word.  If doing this in a Web Adjuster filter, see comments in the lexconvert source for setup details."""
    ...
    format = sys.argv[i + 1]
    if format == "example":
        return "The 'example' format cannot be used with --ruby; did you mean festival?"  # as above
    elif format == "all":
        return "The --phones all option cannot be used with --ruby"  # (well you could implement it if you want but the resulting ruby would be quite unwieldy)
    if not format in lexFormats:
        return (
            "No such format "
            + repr(format)
    ...
    if "1.45." in vLine:
        ...
        wordRegexps.insert(
            0,
            "(?<=[^A-Za-z0-9_-])(?:of|on|in|that|with|for|was) (?:the|a)(?= )",
        )
    ...
    if gradint_cgi:
        linkStart, linkEnd = (
            lambda w: maybe_bytes('<a href="', w)
            + maybe_bytes(gradint_cgi, w)
            + maybe_bytes("?js=[[", w)
            + w.replace(maybe_bytes("%", w), maybe_bytes("%25", w)).replace(
                maybe_bytes("&", w), maybe_bytes("%26", w)
            )
            + maybe_bytes(']]&jsl=en" onclick="return h5a(this);">', w),
            "</a>",
        )
        print(
...
//--></script>"""
        ...
        linkStart, linkEnd = lambda w: maybe_bytes("", w), ""
    rubyList = []
    for clause in parseIntoWordsAndClauses("espeak", response):
        for w in clause:
            ...
            rubyList.append(
                linkStart(w)
                + m.replace(
                    maybe_bytes("&", m), maybe_bytes("&amp;", m)
                ).replace(maybe_bytes("<", m), maybe_bytes("&lt;", m))
                + maybe_bytes(linkEnd, w)
            )
    ...
    matches = {}
    debug = (
        False  # if True, will add ruby title=(index of the regexp that matched)
    )
    debugCount = 0
    ...
    for start, end in sorted(list(matches.keys()), cmpFunc):
        ...
        if start == end:
            ...
            m = (
                text[start:end]
                .replace(maybe_bytes("&", text), maybe_bytes("&amp;", text))
                .replace(maybe_bytes("<", text), maybe_bytes("&lt;", text))
            )
        try:
            rt = rubyList.pop()
        ...
        if debug:
            title = as_utf8(" title=") + as_utf8(str(matches[(start, end)]))
        else:
            title = as_utf8("")
        r.append(
            as_utf8("<ruby")
...
def pipeThroughEspeak(inpt):
    ...
    while len(inpt) > bufsize:
        ...
        inpt = inpt[splitAt:]
    try:
        w, r = os.popen4("espeak -q -x", bufsize=bufsize)  # Python 2
...
def mainopt_check_variants(i):
    ...
    for k, v in i:
        ...
        while True:
            ...
            getBuf(es).write(
                as_utf8("\n").join(
                    [markup_inline_word("espeak", w) for _, w in v]
                )
            )
            del es
            if not int(str(input("Again? 1/0: "))):
                break


def mainopt_check_for_similar_formats(i):
    # undocumented (won't appear in help text)
    items = lexFormats.items()
    r = []
    while items:
        k1, dic1 = items[0]
...
E.g.: python lexconvert.py --convert festival cepstral"""
    ...
    try:
        ...
        getSetting(
            toFormat, "lex_entry_format"
        )  # convert_user_lexicon will need this
    except KeyError:
        fname = None
    if not fname:
        return (
    ...
    if toFormat == "espeak":
        ...
        if os.system(
            'mv en_extra en_extra~ && (grep " // " en_extra~ || true) > en_extra'
        ):
            sys.stderr.write(
    ...
    print(
        "Writing %s lexicon entries to %s file %s"
        % (fromFormat, toFormat, fname)
    )
    try:
...
Attempt to break 'words' into syllables for music lyrics (uses espeak to determine how many syllables are needed)"""
    ...
    for txt in getInputText(i + 1, "word(s)", "maybe"):
        ...
        response = pipeThroughEspeak(
            as_utf8("\n")
            .join(as_utf8(w) for w in words)
            .replace(as_utf8("!"), as_utf8(""))
            .replace(as_utf8(":"), as_utf8(""))
            .replace(as_utf8("."), as_utf8(""))
        )
        if (
        ...
        print(
            " ".join(
                [
                    hyphenate(
                        word, sylcount(convert(line, "espeak", "example"))
                    )
                    for word, line in zip(words, filter(lambda x: x, rrr))
                ]
            )
        )
...
Perform a one-off conversion of phonemes from format1 to format2 (format2 can be 'all' if you want)"""  # If format1 is 'example' and you don't specify phonemes, we take the words from the example lexicon.  But don't say that in the help string because it might confuse the issue about phonemes being optional on the command line and prompted for if not specified and stdin is not piped in all formats other than 'example'.
    ...
    if format1 == "example" and len(sys.argv) <= i + 3:
        if stdin_is_terminal():
            ...
            txt = getBuf(sys.stdin).read()  # and it might still be ""
        if txt:
            parseIntoWordsAndClauses(format1, txt)
        else:
            clauses = [
                [x[1]] for x in getSetting("example", "lex_read_function")()
            ]
    else:
    ...
    for format2 in formats:
        ...
        getBuf(sys.stdout).write(
            as_utf8(checkSetting(format2, "inline_header"))
        )
        output_clauses(format2, convert(clauses, format1, format2))
        getBuf(sys.stdout).write(
            as_utf8(checkSetting(format2, "inline_footer"))
        )
        print("")
...
Speak text in Mac OS 10.7+ British voices while using a lexicon converted in from <from-format>. As these voices do not have user-modifiable lexicons, lexconvert must binary-patch your system's master lexicon; this is at your own risk! (Superuser privileges are needed the first time. A backup of the system file is made, and all changes are restored on normal exit but if you force-quit then you might need to restore the backup manually. Text speaking needs to be under lexconvert's control because it usually has to change the input words to make them fit the available space in the binary lexicon.) By default the Daniel voice is used; Emily or Serena can be selected by setting the MACUK_VOICE environment variable."""
    ...
    assert (
        sys.version_info[0] == 2
    ), "--mac-uk has not been tested with Python 3, I don't want to risk messing up your system files, please use Python 2"
    fromFormat = sys.argv[i + 1]
    ...
    try:
        for line in getInputText(i + 2, "text", True):
            m = MacBritish_System_Lexicon(
                line, os.environ.get("MACUK_VOICE", "Daniel")
            )
            try:
                m.readWithLex(lex)
            finally:
...
def makeDic(doc, *args, **kwargs):
    ...
    for a in args:
        ...
        if k in d:
            duplicates.add(k)
        v = a[1]
        assert (type(k) in [bytes, unicode] and type(v) in [int, float]) or (
            type(v) in [bytes, unicode] and type(k) in [int, float]
        ), (
            "Wrong types "
            + repr(a)
    ...
    if missing and "approximate_missing" in kwargs:
        for miss, approxTo in [
            ...
            (
                a_as_in_apple,
                [a_as_in_ah],
            ),  # the reverse of the above, for Devanagari
            (o_as_in_orange, [oo_as_in_food]),
            (o_as_in_go, [oo_as_in_food]),
            (oy_as_in_toy, [oo_as_in_food, i_as_in_it]),
            (o_as_in_now, [a_as_in_ah, w]),
            (e_as_in_herd, [u_as_in_but, u_as_in_but]),
            (ar_as_in_year, [u_as_in_but, u_as_in_but]),
            (eye, [a_as_in_ah, y]),
            (
                th_as_in_think,
                [th_as_in_them],
            ),  # (Devanagari: is this really the best we can do?)
        ]:
            if miss in missing and all(x in d for x in approxTo):
                d[miss] = maybe_bytes(
                    kwargs.get("phoneme_separator", " "), d[approxTo[0]]
                ).join(d[x] for x in approxTo)
                # did_approx = True
                missing.remove(miss)
    ...
    if missing:
        ...
        sys.stderr.write(
            ...
            + ", ".join(
                "/".join(g for g, val in globals().items() if val == m)
                for m in missing
            )
            + "\n"
        )
    ...
    if not wsep == None:
        assert not wsep in d, "word_separator duplicates with a key in " + repr(
            doc
        )
    if not psep == None:
...
try:
    bytes  # Python 3 and newer Python 2
except:
    bytes = str  # older Python 2
try:
    unicode  # Python 2
except:  # Python 3
    ...
    def sorted(l, theCmp=None):
        if theCmp:
            ...
            return _builtin_sorted(l)

    assert (
        sys.version_info[1] > 4
    ), "lexconvert cannot run on Python 3.4 due to lack of byte-string percent formatting (PEP 461).  Please use Python 3.5+ or stick with Python 2."


def getBuf(f):
    "Return a buffer to which bytes may be written, for Python 2 and 3 compatibility"
    try:
        return f.buffer  # Python 3
...
def make_dictionary(sourceName, destName):
    ...
    for k, v in source.items():
        ...
        try:
            ...
            pass
    try:
        if any(type(v) == unicode for v in d.values()):
            d, dest_consonants = (
                dict((k, as_unicode(v)) for k, v in d.items()),
                set(as_unicode(v) for v in dest_consonants),
            )  # Python 2: if ANY dest are Unicode, make them ALL Unicode
    except UnicodeDecodeError:
        d, dest_consonants = (
            dict((k, as_utf8(v)) for k, v in d.items()),
            set(as_utf8(v) for v in dest_consonants),
        )  # ... or make them ALL byte-strings if some were binary and not readable as UTF-8
...
def convert(pronunc, source, dest):
    ...
    if source == dest:
        return pronunc  # essential for --try experimentation with codes not yet supported by lexconvert
    ...
    for s, r in checkSetting(source, "cvtOut_regexps"):
        pronunc = re.sub(
            maybe_bytes(s, pronunc), maybe_bytes(r, pronunc), pronunc
        )
    ret = []
    toAddAfter = None
        ...
        for lettersToTry in range(maxLen, -1, -1):
            if not lettersToTry:
                if safe_to_drop == True:
                    ...
                    (not safe_to_drop)
                    or not pronunc[:1] in maybe_bytes(safe_to_drop, pronunc)
                    and not (pronunc[:1], debugInfo) in warnedAlready
                ):
                ...
                isStressMark = toAdd and toAdd in [
                    maybe_bytes(
                        lexFormats[dest].get(primary_stress, ""), toAdd
                    ),
                    maybe_bytes(
                        lexFormats[dest].get(secondary_stress, ""), toAdd
                    ),
                ]
                if toAdd == maybe_bytes(
                    lexFormats[dest].get(syllable_separator, ""), toAdd
                ):
                    pass
                    ...
                    if checkSetting(source, "stress_comes_before_vowel"):
                        ...
                        r = len(ret) - 1
                        while ret[r] in dest_consonants or ret[r].endswith(
                            maybe_bytes("*added", ret[r])
                        ):
                            r -= 1  # (if that raises IndexError then the input had a stress mark before any vowel) ("*added" condition is there so that implicit vowels don't get the stress)
                    ...
                    i = len(ret)
                    while i and (
                        ret[i - 1] in dest_consonants
                        or ret[i - 1].endswith(
                            maybe_bytes("*added", ret[i - 1])
                        )
                    ):
                        i -= 1
                    if i:
                    ...
                    if dest_syllable_sep:
                        ret.append(
                            maybe_bytes(dest_syllable_sep, toAdd)
                ...
                # attempt to sort out the festival dictionary's (and other's) implicit_vowel_before_NL
                    ...
                    and ret[-1]
                    and toAdd
                    in [maybe_bytes("n", toAdd), maybe_bytes("l", toAdd)]
                    and ret[-1] in dest_consonants
                ):
                    ret.append(
                        maybe_bytes(implicit_vowel_before_NL, toAdd)
                        + maybe_bytes("*added", toAdd)
                    )
                elif (
                    len(ret) > 2
                    and ret[-2].endswith(maybe_bytes("*added", ret[-2]))
                    and toAdd
    ...
    if not ret:
        ...
        ret = (
            maybe_bytes(separator, ret[0])
            .join(ret)
            .replace(maybe_bytes("*added", ret[0]), maybe_bytes("", ret[0]))
        )
...
def unicode_preprocess(pronunc):
    ...
    if (
        maybe_bytes("\\u", pronunc) in pronunc
        and not maybe_bytes('"', pronunc) in pronunc
...
def ascii_braille_to_unicode(a):
    ...
    d = dict(
        zip(
            ...
            [unichr(c) for c in range(0x2800, 0x2840)],
        )
    )
...
def unicode_to_ascii_braille(u):
    ...
    if r.startswith(",7") and r.endswith("7'"):
        r = r[2:-2]
    return r
...
def espeak_probably_right_already(existing_pronunc, new_pronunc):
    ...
    def simplify(pronunc):
        return (
            pronunc.replace(maybe_bytes(";", pronunc), maybe_bytes("", pronunc))
            ...
            .replace(maybe_bytes("I", pronunc), maybe_bytes("i:", pronunc))
            .replace(maybe_bytes("i@", pronunc), maybe_bytes("i:@", pronunc))
            .replace(maybe_bytes(",", pronunc), maybe_bytes("", pronunc))
    ...
    if as_printable(simplify(existing_pronunc)) == as_printable(
        simplify(new_pronunc)
    ):
        return True  # almost the same, and festival @/a2 etc seems to be a bit ambiguous so leave it alone
...
def convert_system_festival_dictionary_to_espeak(
    ...
    el = open("en_list")
    for line in filter(
        lambda x: x.split() and not re.match(maybe_bytes(r"^[a-z]* *\$", x), x),
        getBuf(el).read().split(as_utf8("\n")),
    ):
        ambiguous[line.split()[0]] = ambiguous[
            line.split()[0] + as_utf8("s")
        ] = True  # this stops the code below from overriding anything already in espeak's en_list.  If taking out then you need to think carefully about words like "a", "the" etc.
    ...
    itemList.sort()
    i0, i1 = (
        itemList[: int(len(itemList) / 2)],
        itemList[int(len(itemList) / 2) :],
    )
    itemList = []
    while i0 or i1:
        if i0:
            itemList.append(i0.pop())
        if i1:
            itemList.append(i1.pop())
    for word, (pronunc, pos) in itemList:
        ...
        if not re.match(
            ...
            or word
            in "friday saturday sunday tuesday thursday yesterday".split()
        ):
    ...
    for word, (pronunc, pos) in items:
        ...
        if not unrelated_word:
            lines_output += 1
        getBuf(outFile).write(
            as_utf8(word)
            + as_utf8(" ")
            + as_utf8(new_e_pronunc)
            + as_utf8(" // from Festival's (")
            + as_utf8(pronunc)
            + as_utf8(")")
        )
        if espeakPronunc:
            getBuf(outFile).write(
                as_utf8(", not [[") + as_utf8(espeakPronunc) + as_utf8("]]")
            )
        elif unrelated_word:
            getBuf(outFile).write(
                as_utf8(
    ...
    if not_output_because_ok:
        ...
        for word, pronunc in zip(
            not_output_because_ok, getBuf(tp).read().split(as_utf8("\n"))
        ):
            pronunc = pronunc.strip().replace(as_utf8(" "), as_utf8(""))
            if not pronunc == oldPronDic[
                word
            ] and not espeak_probably_right_already(oldPronDic[word], pronunc):
                getBuf(outFile).write(
                    as_utf8(word)
                    + as_utf8(" ")
                    + oldPronDic[word]
...
def read_user_lexicon(fromFormat):
    ...
    try:
        ...
        if lexFilename == None:
            lexfile = None  # e.g. the example lexicon
        else:
        ...
        lexfile = None  # lex_read_function without lex_filename is allowed, if the read function can take null param and fetch the lexicon itself
    except IOError:
        raise Message(
            fromFormat
...
def convert_user_lexicon(fromFormat, toFormat, outFile):
    ...
    if type(lex_header) in [bytes, unicode]:
        getBuf(outFile).write(as_utf8(lex_header))
    else:
        lex_header(outFile)
    ...
    for word, pronunc in lex:
        ...
        if wordCase == "upper":
            ...
            word = word.lower()
        getBuf(outFile).write(
            as_utf8(entryFormat) % (as_utf8(word), as_utf8(pronunc))
        )  # will work in Python 3.6, but not in Python 3.4 (e.g. on jessie) which cannot do % on byte-strings
    footer = checkSetting(toFormat, "lex_footer")
    if type(footer) in [bytes, unicode]:
        getBuf(outFile).write(as_utf8(footer))
    else:
        footer(outFile)
    ...
    while pronunc:
        ...
        for (
            ...
            if pronunc.startswith(as_utf8(p)):
                ...
                break
        if not found:
            assert as_printable(pronunc[:1]) in "12345678", (
                "Unrecognised BBC Micro phoneme at "
                + str(pronunc)
                + " in "
                + str(pronunc0)
            )
...
def sylcount(example_format_festival):
    ...
    for phone, i in zip(festival, range(len(festival))):
        ...
        if phone[:1] in "aeiou@12":
            ...
            if not phone[:1] in "drz":
                count += maybeCount  # not 'r/z' e.g. "ours", "fired" usually 1 syllable in songs, "desirable" usually 4 not 5
    ...
    for i in range(numSyls):
        ...
        if len(syls) > 1:
            if syls[-1].startswith("-") or (
                len(syls[-1]) > 2
                and syls[-1][:1] == syls[-1][1:2]
                and not syls[-1][:1].lower() in "aeiou"
            ):
                ...
                or (
                    syls[-1]
                    and syls[-1][:1].lower() in "aeiouy"
                    and len(syls[-2]) > 2
                )
            ) and list(
                filter(lambda x: x.lower() in "aeiou", list(syls[-2][:-1]))
            ):
...
def output_clauses(format, clauses):
    ...
    if type(clause_sep) in [bytes, unicode]:
        getBuf(sys.stdout).write(
            as_utf8(clause_sep).join(
                as_utf8(wordSeparator(format)).join(
...
def write_bbcmicro_phones(clauses):
    ...
    for clause in clauses:
        ...
        bbc_charsSoFar = 0
        l = as_utf8(" ").join(
            [markup_inline_word("bbcmicro", word) for word in clause]
        )
...
def print_bbc_warnings(keyCount, lineCount):
    ...
    for page, model in [
        ...
        # Some other ROMs (e.g. Alan Blundell's "Informant" 1989) seem to result in a crash after the *SPEECH and/or *SPEAK commands complete, at least in some emulator configurations; this may or may not be resolved via timing adjustments or adjustments in the ROM order; not sure exactly what the problem is
            ...
            x = " (Speech program will be overwritten unless relocated)"  # (could use Sideways RAM for it instead if you have it fitted, see above)
...
def bbcKeystrokes(data, start):
    ...
    while i < len(data):
        ...
        if data[i : i + 1] == as_utf8('"'):
            c, inQ = (
                as_utf8('""'),
                1,
            )  # inQ MUST be 0 or 1, not False/True, because it's also used as 'len of necessary close quote' below
        elif 32 <= ord(data[i : i + 1]) < 127:
            c, inQ = data[i : i + 1], 1
        elif use_int_hack and ord(data[i : i + 1]) == 128:
            c, inQ = as_utf8("$A%"), 0
        else:
            c, inQ = (as_utf8("CHR$(" + str(ord(data[i : i + 1])) + ")")), 0
        addToLine = []
...
def print_bbclex_instructions(fname, size):
    ...
    if os.environ.get("MAKE_SPEECH_ROM", 0):
        ...
        def special_relocate_instructions(reloc_addr):
            ...
            if newpage > page_max:
                return False  # "Unfortunately RELOCAT can't put it at &%X even with PAGE changes." % reloc_addr
            return (
...
def main():
    ...
    html, markdown = (
        ...
        ("--mdhelp" in sys.argv),
    )  # (undocumented options used for my website, don't rely on them staying)

    def htmlify(h):
        h = h.replace("&", "&amp;").replace("<", "&lt;").replace(">", "&gt;")
        h = h.replace("\n", "<br>")
        h = re.sub(
            "(--[2A-Za-z-]*)", r"<kbd>\1</kbd>", h
        )  # command-line option
        h = re.sub(
            "(?<= )([A-Z]+_[A-Z_]*)(?= )", r"<code>\1</code>", h
        )  # BRAILLE_UNICODE etc (as a word between spaces)
        h = re.sub(
            "(?<= )(export [A-Z]+_[A-Z_]*=1)", r"<kbd>\1</kbd>", h
        )  # export DTALK_COMMAND_CODE=1
        h = re.sub(" ('\\\\u[0-9a-fA-F\\\\un]*')", r" <kbd>\1</kbd>", h)
        h = (
            h.replace("lexconvert.py", "<code>lexconvert.py</code>")
            .replace("[[inpt PHON]]", "<code>[[inpt PHON]]</code>")
            .replace(
                "python <code>lexconvert.py</code>",
                "<kbd>python lexconvert.py</kbd>",
            )
            .replace("~/.festivalrc", "<code>~/.festivalrc</code>")
            .replace(r"'\uNNNN'", r"<kbd>'\uNNNN'</kbd>")
        )
        h = re.sub("(?<=[a-z])/", "<wbr>/", h)
    ...
    if (
        ...
        print(
            ...
            + ", ".join(sorted(list(lexFormats.keys())))
    ...
    if html:
        print("<dl>")
    for _, opt, desc in sorted(
        [
            (not not v.__doc__ and not v.__doc__.startswith("*"), k, v.__doc__)
            for k, v in globals().items()
        ]
    ):
...
class MacBritish_System_Lexicon(object):
    ...
    def __init__(self, text="", voice="Daniel"):
        ...
        if os.path.exists(self.filename + "0"):
            if text == False:
                self.filename += "0"  # (use the backup file for read-only, if we created one before; this means we don't have to worry about locks)
        ...
        if os.path.exists(lexFile) and os.stat(lexFile).st_size:
            (
                ...
                self.phIndexStart,
                self.phIndexEnd,
            ) = cPickle.Unpickler(open(lexFile)).load()
        else:
            ...
            def findW(word, rtnPastEnd=0):
                ...
                try:
                    ...
                    raise Exception(
                        word + " not found in voice file" + compat_err
                    )
                try:
                    n2 = i.next()
                    raise Exception(
            ...
            if not text == False:
                cPickle.Pickler(open(lexFile, "w")).dump(
                    (
                        self.wordIndexStart,
                        self.wordIndexEnd,
                        self.phIndexStart,
        ...
        self.textToAvoid = text.decode("utf-8").replace(unichr(160), " ")
        self.restoreDic = {}
        catchSignals()
    ...
    def allWords(self):
        ...
        return [
            x
            for x in getBuf(self.dFile)
            .read(self.wordIndexEnd - self.wordIndexStart)
            .split(chr(0))
            if x
        ]
    ...
    def allPh(self):
        ...
        return f(
            [
                x
                for x in getBuf(self.dFile)
                .read(self.phIndexEnd - self.phIndexStart)
                .split(chr(0))
            ]
        )
    ...
    def usable_words(self, words_ok_to_redefine=[]):
        ...
        for word, (pos, phonemes) in zip(self.allWords(), self.allPh()):
            ...
            if not (phonemes and 32 < ord(phonemes[:1]) < 127):
    ...
    def speakPhones(self, phonesList):
        ...
        getBuf(msc).write(
            as_utf8(" ").join(d.get(w, as_utf8("")) for w in words)
        )
    ...
    def readWithLex(self, lex):
        ...
        for k, v in self.setMultiple(words2, phonemes2).iteritems():
            tta = re.sub(
                nonWordBefore + re.escape(k) + nonWordAfter, chr(0) + v, tta
            )
            textToPrint = re.sub(
                nonWordBefore
                + "("
    ...
    def setMultiple(self, words, phonemes):
        ...
        for l, word, phon in needed:
            while (
                ...
                or (
                    mustBeAlpha
                    and not re.match(as_utf8("[A-Za-z]"), avail[i][1])
                )
                or i in iDone
            ):
                i += 1
            ...
            if avail[i][2] in self.restoreDic:
                oldPhon = None  # shouldn't happen if setMultiple is called only once, but might be useful for small experiments in the Python interpreter etc
            self.set(pos, phon, oldPhon)
            wDic[word] = (
                wSubst[:1].upper() + wSubst[1:]
