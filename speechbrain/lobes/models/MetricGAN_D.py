...
class MetricGAN_D(nn.Module):
    ...
    def __init__(
        ...
        self.conv1 = Conv2d(in_channels=2, kernel_size=kernel_size, out_channels=base_channels)
        self.conv2 = Conv2d(in_channels=base_channels, kernel_size=kernel_size, out_channels=base_channels)
        self.conv3 = Conv2d(in_channels=base_channels, kernel_size=kernel_size, out_channels=base_channels)
        self.conv4 = Conv2d(in_channels=base_channels, kernel_size=kernel_size, out_channels=base_channels)
