...
try:
    ...
    MSG = "Please install transformers from HuggingFace to use LLAMA2\n"
...
class HuggingFaceLLAMA2(nn.Module):
    ...
    def __init__(
        ...
        self.model = AutoModelForCausalLM.from_pretrained(
            source, quantization_config=bnb_config, cache_dir=save_path
        )
        ...
        # if self.freeze:
        #     logger.warning("huggingface_LLAMA2 - LLAMA2  is frozen.")
