...
class EndToEndSLUZ(Pretrained):
    ...
    HPARAMS_NEEDED = ["tokenizer","beam_searcher"]
    MODULES_NEEDED = [
        "wav2vec2",
        "slu_enc",
    ]
    ...
    def encode_batch(self, wavs, wav_lens):
        ...
        with torch.no_grad():
            wav2vec2_out =  self.hparams.wav2vec2(wavs)
            
        encoder_out = self.modules.slu_enc(wav2vec2_out)
        return encoder_out
