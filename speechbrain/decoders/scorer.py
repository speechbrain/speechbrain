...
class BaseRescorerInterface(BaseScorerInterface):
    ...
    It is important to note that you have the flexibility to rescore using a language model 
    that employs different tokenization methods than your Acoustic Model.
...
class ScorerBuilder:
    ...
    def __init__(
        ...
        assert len(rescorers_weights) == len(rescorers), "Weights and rescorers are not matched."
    ...
    def score(
        self, inp_tokens, memory, attn, log_probs, beam_size
    ):
