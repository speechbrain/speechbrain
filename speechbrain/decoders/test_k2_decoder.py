...
def main():
    ...
    if use_LM:
        ...
        if not os.path.exists("./HLG.pt"):
            ...
            words = k2_v2.read_words(words_txt, excluded)
            lexicon = []
            for word in words[:]:
            ...
            (
                ...
                L_disambig,
            ) = k2_v2.test_read_lexicon(lexicon, tokens, words)
        ...
        predicted_tokens, scores = k2_v2.HLG_decoding(log_probs, HLG)
        ...
        if use_k2:
            ...
            predicted_tokens, scores = k2_v2.ctc_decoding(log_probs, ctc_topo)
            print(predicted_tokens)
            print(scores)
