...
class NgramCounts:
    ...
    def save_to_file(self, out_file, encoding=DEFAULT_ENCODING):
        """Save the language model to file.
...
def make_kn_lm(text, lm, ngram_order):
    ...
    text : Union[str, Iterable[str]]
        The text to train the language model. It can be a file containing text sentences in each line,
        or a list of strings, where each string contains a sequence of integer word-ids.
    lm : str
        The file to save the language model. If None, the language model will be printed to stdout.
    ngram_order : int
        The order of n-gram.
    """
