...
.. list-table::
   ...
   * - Parcollet T. & Moumen A.
     ...
     - Difficulty: medium
     - Time: 20m
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/master/tutorials/nn/using-wav2vec-2.0-hubert-wavlm-and-whisper-from-huggingface-with-speechbrain.ipynb>`__
...
.. list-table::
   ...
   * - Parcollet T.
     ...
     - Difficulty: medium
     - Time: 30min
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/master/tutorials/nn/complex-and-quaternion-neural-networks.ipynb>`__
...
.. list-table::
   ...
   * - Ravanelli M.
     ...
     - Difficulty: easy
     - Time: 30min
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/master/tutorials/nn/recurrent-neural-networks-and-speechbrain.ipynb>`__
