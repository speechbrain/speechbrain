...
`Speech Recognition From Scratch <asr/speech-recognition-from-scratch.html>`_
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
.. list-table::
   ...
   * - Ravanelli M. & Parcollet T.
     ...
     - Difficulty: medium
     - Time: 45min
     - `Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/master/tutorials/asr/speech-recognition-from-scratch.html>`__
...
.. toctree::
   ...
   asr/speech-recognition-from-scratch.html
