...
`Speech Enhancement From Scratch <enhancement/speech-enhancement-from-scratch.html>`_
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
.. list-table::
   ...
   * - Plantinga P.
     ...
     - Difficulty: medium
     - Time: 30min
     - `Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/master/tutorials/enhancement/speech-enhancement-from-scratch.html>`__
...
.. toctree::
   ...
   enhancement/speech-enhancement-from-scratch.html
