...
.. list-table::
   ...
   * - Ravanelli M.
     ...
     - Difficulty: easy
     - Time: 20min
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/develop/tutorials/processing/speech-augmentation.ipynb>`__
...
.. list-table::
   ...
   * - Ravanelli M.
     ...
     - Difficulty: easy
     - Time: 20min
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/develop/tutorials/processing/fourier-transform-and-spectrograms.ipynb>`__
...
.. list-table::
   ...
   * - Ravanelli M.
     ...
     - Difficulty: easy
     - Time: 20min
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/develop/tutorials/processing/speech-features.ipynb>`__
...
.. list-table::
   ...
   * - Ravanelli M.
     ...
     - Difficulty: medium
     - Time: 20min
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/develop/tutorials/processing/environmental-corruption.ipynb>`__
...
.. list-table::
   ...
   * - Grondin F. & Aris W.
     ...
     - Difficulty: medium
     - Time: 20min
     - `🔗 Google Colab <https://colab.research.google.com/github/speechbrain/speechbrain/blob/develop/tutorials/processing/multi-microphone-beamforming.ipynb>`__
