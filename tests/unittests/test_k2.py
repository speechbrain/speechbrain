...
try:
    ...
    raise ImportError("Please install k2 with `pip install k2`")
...
def test_read_lexicon(mock_lexicon_file):
    expected_output = [("hello", ["h", "e", "l", "l", "o"]),
                       ("world", ["w", "o", "r", "l", "d"])]
...
world w o r l d'''
        ...
        assert lexicon.texts2tids(["hello world"], add_sil_token_as_separator=True)[0] == expected_sil_tids
