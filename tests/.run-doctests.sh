...
avoid="transducer_loss.py\|fairseq_wav2vec.py\|huggingface_wav2vec.py\|bleu.py\|ctc_segmentation.py\|check_url.py\|huggingface_whisper.py\|language_model.py\|vocos.py|discrete_wav2vec2.py\|discrete_wavlm.py\|discrete_hubert.py\|lobes/fasttext|lobes/flair|lobes/spacy"
