...
avoid="transducer_loss.py\|fairseq_wav2vec.py\|speechbrain/lobes/models/huggingface/interfaces.py\|speechbrain/lobes/models/huggingface/lib_forward.py\|speechbrain/lobes/models/huggingface/transformers.py\|bleu.py\|ctc_segmentation.py\|check_url.py"
