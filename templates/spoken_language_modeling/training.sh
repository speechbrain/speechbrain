...
#SBATCH --output=logs/wavlm_%A_%a.out
...
scp -r $SCRATCH/results/wavlm_libriheavy_last_inch/ $SLURM_TMPDIR/
...
srun python train.py hparams/speechlm.yaml --data_path $SLURM_TMPDIR
